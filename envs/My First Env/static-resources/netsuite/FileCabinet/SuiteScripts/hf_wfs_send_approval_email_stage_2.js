 ...
 define(['N/search', 'N/email','N/url','N/record','N/runtime'], function (search, email, url, record, runtime) {
    function onAction(scriptContext) {
        ...
        var employeeSearchObj = search.load({
            id: 'customsearch_hf_accounting_and_finance_d'
        });
