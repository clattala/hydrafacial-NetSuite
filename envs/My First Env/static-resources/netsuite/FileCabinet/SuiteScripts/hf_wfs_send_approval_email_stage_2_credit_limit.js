    ...
    function getUrl(recId){
   	...
   	function acceptanceEmail(scriptContext) {
        ...
        if(createdBy != submittedForApprovalBy){
      	...
      	log.debug('submittedForApprovalBy', submittedForApprovalBy);
