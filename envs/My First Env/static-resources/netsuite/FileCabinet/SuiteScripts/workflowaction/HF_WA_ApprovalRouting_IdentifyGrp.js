        ...
        try {
            ...
            if (objReqAppGrp.internalid && objReqAppGrp.name) {
              ...
              log.debug(`arrApprovers split value`, arrApprovers);
                ...
                newRecord.setValue({ fieldId: _RECORDS.TRANSACTION.FIELDS.appgroup, value: objReqAppGrp.internalid }); // Approval Group
                newRecord.setValue({ fieldId: _RECORDS.TRANSACTION.FIELDS.grpapprovers, value: arrApprovers }); // Approvers
