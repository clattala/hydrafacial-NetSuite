		...
		<div class="product-details-information-content-container">
			...
			<div role="tabpanel">
				...
				<div class="product-details-information-tab-content" data-type="information-content" data-action="tab-content">
					{{#each details}}
						<div role="tabpanel" class="product-details-information-tab-content-panel-persist {{#if @first}}active{{/if}}" id="product-details-information-tab-{{@index}}" {{#if @first}}itemprop="description"{{/if}} data-action="pushable" data-id="product-details-information-{{ @index
                        }}">
