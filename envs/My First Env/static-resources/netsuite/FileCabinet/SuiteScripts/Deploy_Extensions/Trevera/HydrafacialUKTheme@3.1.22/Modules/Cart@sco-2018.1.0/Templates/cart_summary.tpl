<div data-cms-area="uk_cart_summary_cms_area_1" data-cms-area-filters="path"></div>
...
<div class="cart-summary">
    <div class="cart-summary-container">
        ...
        {{#if isPriceEnabled}}
            <div class="cart-summary-subtotal">
                ...
                {{!-- <p class="cart-summary-grid-float">
                    <span>You Will Earn: {{ summary.subtotal }} Points.</span><br>
                </p> --}}
                {{#if showEstimate}}
    ...
    <div data-cms-area="uk_cart_summary_cms_area_2" data-cms-area-filters="path"></div>
...
<div data-cms-area="uk_cart_summary_cms_area_3" data-cms-area-filters="path"></div>
