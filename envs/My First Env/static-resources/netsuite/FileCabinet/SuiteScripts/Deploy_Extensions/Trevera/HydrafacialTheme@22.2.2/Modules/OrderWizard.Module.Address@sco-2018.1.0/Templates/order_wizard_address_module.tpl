<div class="order-wizard-address-module">
    {{#if showTitle}}
        <h2 class="order-wizard-address-module-title">
            {{title}}
        </h2>
    {{/if}}
    <div class="checkout-cms-area" data-cms-area="checkout-shipping-address-before" data-cms-area-filters="path"></div>
        ...
        {{#if isSameAsEnabled}}
            <label class="order-wizard-address-module-checkbox">
                <input
                        ...
                        type="checkbox" name="same-as-address" data-action="same-as" value="1"
    ...
    <div class="checkout-cms-area" data-cms-area="checkout-shipping-address-after" data-cms-area-filters="path"></div>
</div>
