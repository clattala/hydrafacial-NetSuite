...
<div class="cart-detailed">
    ...
    <div data-cms-area="uk_cart_detailed_cms_area_1" data-cms-area-filters="path"></div>
    ...
    <div class="cart-detailed-body">
        <section class="{{#if showLines}}cart-detailed-left {{else}}cart-detailed-empty{{/if}}">
            ...
            <div data-cms-area="uk_cart_detailed_cms_area_2" data-cms-area-filters="path"></div>
        </section>
    ...
    <div data-cms-area="uk_cart_detailed_cms_area_3" data-cms-area-filters="path"></div>
</div>
