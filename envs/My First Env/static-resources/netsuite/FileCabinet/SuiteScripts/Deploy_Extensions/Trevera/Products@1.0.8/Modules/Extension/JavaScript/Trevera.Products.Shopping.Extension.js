            ...
            , function trvExtras(context) {
              ...
              switch (pricelevel) {
                case 29: // schybrid
                  ...
                  return {
                    showComparePrice     : price < comparePrice,
                    comparePriceFormatted: context.model.item.pricelevel26_formatted,
                    showTooltip          : tooltip && tooltip.length > 0,
                    tooltip              : tooltip
                  }
                  break;
                case 30: // wshybrid
                  ...
                  break;
                case 31: // bdhybrid
                  comparePrice = context.model.item.pricelevel29;
                  price        = context.model.item.pricelevel31;
                  return {
                    showComparePrice     : price < comparePrice,
                    comparePriceFormatted: context.model.item.pricelevel29_formatted,
                    showTooltip          : tooltip && tooltip.length > 0,
                    tooltip              : tooltip
                  }
                  break;
