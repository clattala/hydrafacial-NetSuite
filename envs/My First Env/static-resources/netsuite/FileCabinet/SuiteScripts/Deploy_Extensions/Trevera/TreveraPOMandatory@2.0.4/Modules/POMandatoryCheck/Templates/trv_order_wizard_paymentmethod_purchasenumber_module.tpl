<div class="order-wizard-paymentmethod-purchasenumber-module">
    ...
    <div class="order-wizard-paymentmethod-purchasenumber-module-row">
        ...
        <input type="text" name="purchase-order-number" id="purchase-order-number" data-action="validate-po" class="order-wizard-paymentmethod-purchasenumber-module-purchase-order-value" value="{{purchasenumber}}" {{#if isRequired}}required{{/if}}>
    </div>
</div>
