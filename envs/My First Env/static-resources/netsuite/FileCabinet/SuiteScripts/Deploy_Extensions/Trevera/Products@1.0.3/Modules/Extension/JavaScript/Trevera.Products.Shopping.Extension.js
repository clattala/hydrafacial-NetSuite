        ...
        if (LAYOUT) {
          LAYOUT.addToViewContextDefinition(
            ...
            , function trvExtras(context) {
              ...
              console.log('ProductViews.Price.View', item.displayname, pricelevel, item.pricelevel25, item.pricelevel32);
              switch (pricelevel) {
                case 30: // schybrid
                  comparePrice = item.pricelevel26;
                  ...
                  break;
                case 31: // wshybrid
                  comparePrice = item.pricelevel27;
                  ...
                  break;
                case 32: // bdhybrid
                  comparePrice = item.pricelevel25;
                  price        = item.pricelevel32;
                  return {
                    showComparePrice     : price < comparePrice,
                    comparePriceFormatted: item.pricelevel25_formatted,
                    showTooltip          : tooltip.length > 0,
                    tooltip              : tooltip
                  }
                  break;
