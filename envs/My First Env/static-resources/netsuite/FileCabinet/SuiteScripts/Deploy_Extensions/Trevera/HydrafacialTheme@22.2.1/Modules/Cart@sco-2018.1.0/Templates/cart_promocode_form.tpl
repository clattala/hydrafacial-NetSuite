<form class="cart-promocode-form" data-action="apply-promocode" {{!-- for promotions module data-action="apply-promocode" --}}>
        ...
        <div class="cart-promocode-form-summary-container-input">
            <div class="{{#if showErrorMessage}}error{{/if}}">
                ...
                <input
                        ...
                        type="text" name="promocode" id="promocode" class="cart-promocode-form-summary-input" value="{{promocodeCode}}">
            </div>
        </div>
    ...
    <div data-view="promocode-error-placeholder"></div>
