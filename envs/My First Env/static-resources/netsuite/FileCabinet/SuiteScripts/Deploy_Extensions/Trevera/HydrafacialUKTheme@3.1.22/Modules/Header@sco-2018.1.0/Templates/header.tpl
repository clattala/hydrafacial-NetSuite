...
<div class="header-main-wrapper">
    ...
    <div id="banner-header-top" class="content-banner banner-header-top" data-cms-area="uk_header_banner_top" data-cms-area-filters="global"></div>
        ...
        <div class="header-content">
            ...
            <div class="header-right-menu">
                ...
                {{else}}
                    ...
                    <div class="header-menu-profile header-menu-profile-logged-out" data-view="Header.Profile"></div>
                {{/if}}
...
<div id="banner-header-bottom" class="content-banner banner-header-bottom" data-cms-area="uk_header_banner_bottom" data-cms-area-filters="global"></div>
