{{#each promotions}}
    {{#if showPromo}}
        <div class="cart-promocode-list-item cart-promocode-list-item-custom" data-id="{{internalid}}">
            <div class="cart-promocode-list-item-container">
                ...
                <span class="cart-promocode-list-item-code">
                    {{#if isLoyalty}}
                        <span class="cart-promocode-list-item-code-value">{{pointsApplied}} Points Applied</span>
                    {{else}}
