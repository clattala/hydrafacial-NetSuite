<div class="cart-item-actions-links">
	{{#if isAdvanced}}
		...
		{{#if showSaveForLateButton}}
			<a href="#" class="cart-item-actions-item-list-actionable-edit-content-saveforlater" data-action="save-for-later-item" data-internalid="{{lineId}}">
				{{translate 'Save for Later'}}
			</a>
		{{/if}}
	{{/if}}

	<a href="#" class="cart-item-actions-item-list-actionable-edit-content-remove" data-action="remove-item" data-internalid="{{lineId}}">
		{{translate 'Remove'}}
	</a>
</div>
