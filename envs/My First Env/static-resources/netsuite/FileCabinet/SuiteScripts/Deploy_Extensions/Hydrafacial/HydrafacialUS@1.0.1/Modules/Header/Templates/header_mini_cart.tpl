    ...
    {{#if showLines}}
        ...
        <div class="header-mini-cart-subtotal">
            ...
            {{#if isPriceEnabled}}
				...
				{{translate '<span class="header-mini-cart-subtotal-amount-text">Subtotal</span>: $(0)' subtotalFormatted}}
                </div>
            {{/if}}
        ...
        <div class="header-mini-cart-buttons">
            <div class="header-mini-cart-buttons-left {{#unless canCheckout}}header-mini-cart-buttons-left-full{{/unless}}">
