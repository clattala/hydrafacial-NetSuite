...
<div class="cart-summary">
                ...
                {{#if showEstimate}}
                    <div class="cart-summary-expander-container">
                        <div class="cart-summary-expander-head">
							<a href="#" class="cart-summary-expander-head-toggle collapsed" data-toggle="collapse" data-target="#estimate-shipping-form" aria-expanded="false" aria-controls="estimate-shipping-form">
                                {{translate 'Estimate Tax &amp; Shipping'}}
                                <i data-toggle="tooltip" class="cart-summary-expander-tooltip" title="{{translate '<b>Shipping Estimator</b><br>Shipping fees are based on your shipping location. Please enter your information to view estimated shipping costs.'}}"></i><i class="cart-summary-expander-toggle-icon"></i>
                            </a>
                        </div>
    ...
    {{#if showPromocodeForm}}
        <div class="cart-summary-grid cart-summary-promocode-container">
            <div class="cart-summary-expander-head">
				<a href="#" class="cart-summary-expander-head-toggle collapsed" data-toggle="collapse" data-target="#promo-code-container" aria-expanded="false" aria-controls="promo-code-container">
    ...
    {{#if showActions}}
        {{#if elevatedAccess.isElevated}}
            {{#if elevatedAccess.canAddToCart}}
                <button id="btn-proceed-checkout-elevated" data-action="elevated-checkout" class="cart-summary-button-proceed-checkout">
                    {{translate 'BDM Checkout'}}
                </button>
                <div data-view="SalesRepCheckoutMessage"></div>
            {{/if}}
        {{/if}}
        <div class="cart-summary-button-container">
            {{#if treveraExtras.creditLocked}}
                {{translate treveraExtras.creditMessage}}
            {{else}}
