		...
		<div class="quantity-pricing-container">
			{{#if isAccordion}}
				<div class="quantity-pricing-expander-head">
				 	<a href="#" class="quantity-pricing-expander-head-toggle {{#unless isOpen}}collapsed{{/unless}}" data-toggle="collapse" data-target="#expander-body-container-{{itemKey}}" aria-expanded="true" aria-controls="expander-body" data-action="toggle">
				 		{{title}} <i class="quantity-pricing-expander-toggle-icon"></i>
				 	</a>
				</div>
			...
			{{else}}
				<a class="quantity-pricing-flyout-head-toggle" data-toggle="dropdown" aria-expanded="false"> {{title}} <i class="quantity-pricing-flyout-toggle-icon"></i></a>
