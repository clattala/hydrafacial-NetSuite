	...
	<td class="product-list-list-details-actions">
		...
		{{#unless isTypePredefined}}
			<div class="product-list-list-details-button-group">
				...
				<button aria-haspopup="true" aria-label="{{translate 'More options' 'Shows more options to edit the list'}}" class="product-list-list-details-button-expander" data-toggle="dropdown" aria-expanded="false">
					<i></i>
				</button>
