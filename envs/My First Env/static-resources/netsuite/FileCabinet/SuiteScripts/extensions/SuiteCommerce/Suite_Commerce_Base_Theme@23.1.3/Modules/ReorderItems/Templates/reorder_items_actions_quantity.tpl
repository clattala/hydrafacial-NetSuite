<div class="reorder-items-actions-quantity">
	{{#if showQuantityInput}}
		<label for="reorder-items-actions-item-quantity" class="reorder-items-actions-quantity-label">{{translate 'Quantity:'}}</label>
		<div class="reorder-items-actions-quantity-input">
			<button class="reorder-items-actions-quantity-remove" data-action="minus">-</button>
				<input id="reorder-items-actions-item-quantity" type="number" name="item_quantity" data-line-id="{{lineId}}" value="{{itemQuantity}}" class="reorder-items-actions-quantity-value" min="{{minimumQuantity}}" {{#if showMaximumQuantity}} max="{{maximumQuantity}}"{{/if}}>
