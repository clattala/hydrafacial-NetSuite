<section class="order-wizard-cartitems-module-ship">
	<div class="order-wizard-cartitems-module-ship-accordion-head">
		<a href="#" class="order-wizard-cartitems-module-ship-accordion-head-toggle{{#unless showOpenedAccordion}} collapsed{{/unless}}{{#if isAccordionPrimary}} order-wizard-cartitems-module-ship-accordion-primary{{/if}}" data-toggle="collapse" data-target="#unfulfilled-items-ship" aria-controls="unfulfilled-items">
		{{#if showAddress}}
			<span>{{translate 'Ship to ' 'Ship to the customers selected address'}}</span>
			...
			{{#if showAddress}}
				<div class="order-wizard-cartitems-module-ship-dropdown">
					<a
						...
						<span class="order-wizard-cartitems-module-ship-address-label">{{translate 'Ship to' 'It refers to the customer selecting an address from a list'}} </span> {{address.fullname}}
