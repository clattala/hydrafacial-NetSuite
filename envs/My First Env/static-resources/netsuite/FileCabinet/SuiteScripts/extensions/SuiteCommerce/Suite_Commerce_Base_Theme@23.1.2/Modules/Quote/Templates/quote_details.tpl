			...
			<div class="quote-details-summary-col">
				...
				<div class="quote-details-row-fluid">
					...
					{{#if isOpen}}
							...
							<div data-type="quote-details-and-order-msg-placeholder">
								<div class="quote-details-msg">
									{{#if hasPermissionAndHasErrors}}
										<p>{{translate 'To complete this quote, the following information is needed:'}}</p>
										<ul>
						...
						{{/if}}
					{{/if}}
					<a href="{{pdfUrl}}" target="_blank" class="quote-details-button-download-pdf" {{#if disableDownloadAsPDF}}disabled{{/if}}>{{translate 'Download as PDF'}}</a>
				</div>
