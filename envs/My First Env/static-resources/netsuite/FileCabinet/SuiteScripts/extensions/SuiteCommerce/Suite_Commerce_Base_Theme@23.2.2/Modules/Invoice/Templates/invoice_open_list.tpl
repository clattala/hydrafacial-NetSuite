...
<section class="invoice-open-list">
    ...
    <div id="invoice-banner" class="invoice-banner">
        <div data-cms-area="global_banner_invoice-top" data-cms-area-filters="global"></div>
    </div>

	{{#if showInvoices}}
		<div data-view="Invoices.Message"></div>
	{{/if}}
    <div id="invoice-open-list-banner" class="content-banner invoice-open-list-banner" data-cms-area="banner_invoiceopenlist" data-cms-area-filters="global"></div>
