...
define("NetSuite.FeaturedProduct.FeaturedProductCCT.View", ["require", "exports", "underscore", "netsuite_featuredproduct_featuredproductcct.tpl", "SC.FeaturedProduct.Common.Utils", "SC.FeaturedProduct.Common.Configuration", "CustomContentType.Base.View", "SuiteCommerce.FeaturedProduct.Common.DependencyProvider", "SuiteCommerce.FeaturedProduct.Item.Collection", "SuiteCommerce.FeaturedProduct.Common.InstrumentationHelper", "SuiteCommerce.FeaturedProduct.Instrumentation"], function (require, exports, _, template, Common_Utils_1, Common_Configuration_1, CustomContentTypeBaseView, DependencyProvider_1, Item_Collection_1, InstrumentationHelper_1, Instrumentation_1) {
    "use strict";
    ...
    var FeaturedProductCCTView = /** @class */ (function (_super) {
        ...
        FeaturedProductCCTView.prototype.getItemPrice = function (productData) {
            ...
            if (DependencyProvider_1.ProfileModel.getInstance().hidePrices()) {
                return '';
            }
            if (matrixChildItemsDetail && matrixChildItemsDetail.length > 0) {
                ...
                _.each(matrixChildItemsDetail, function (itemDetail) {
                    ...
                    var price = priceDetail.onlinecustomerprice || priceDetail.pricelevel1 || 0;
                    var priceFormatted = priceDetail.onlinecustomerprice_formatted ||
                        priceDetail.pricelevel1_formatted ||
                        '0';
            ...
            return (priceData.onlinecustomerprice_formatted ||
