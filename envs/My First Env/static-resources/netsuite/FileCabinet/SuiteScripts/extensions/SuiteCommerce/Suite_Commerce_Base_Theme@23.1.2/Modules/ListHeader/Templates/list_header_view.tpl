				...
				<div class="list-header-view-accordion-body-header {{classes}}">
					...
					{{#if sorts}}
						<span class="list-header-view-sorts">
							...
							<button aria-labelledby="list-header-view-sorts-select" aria-describedby="button-label" class="list-header-view-accordion-body-button-sort" data-action="toggle-sort">
						    	<span class="label-visually-hidden" id="button-label">
						    	{{#if sortIconUp}}
						    	    {{translate 'Sorted in ascending order' 'Indicates that the current sort order is ascending'}}
						    	{{else}}
						    	    {{translate 'Sorted in descending order' 'Indicates that the current sort order is descending'}}
						    	{{/if}}
						    	</span>
							...
							<label class="list-header-view-filters">
								<select id="list-header-view-sorts-select" title="{{translate 'Sort by' 'Element that allows sorting purchases by criteria'}}" name="sort" class="list-header-view-accordion-body-select" data-action="sort">
									{{#each sorts}}
										<option value="{{value}}" data-permissions="{{permission}}" {{#if selected}} selected {{/if}} aria-selected="{{selected}}">{{name}}</option>
									{{/each}}
								</select>
							</label>
						</span>
