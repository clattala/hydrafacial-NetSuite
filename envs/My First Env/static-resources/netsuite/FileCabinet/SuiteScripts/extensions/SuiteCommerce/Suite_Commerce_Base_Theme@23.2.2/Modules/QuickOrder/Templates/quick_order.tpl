<div class="quick-order">
	<div class="quick-order-divider">
		<div class="quick-order-expander-head">
			<a href="#" class="quick-order-expander-head-toggle {{#unless showOpenedAccordion}}collapsed{{/unless}}" data-toggle="collapse" data-target="#quick-order" aria-expanded="true" aria-controls="quick-order">
				{{translate 'Quick Add'}}
