<div class="order-wizard-paymentmethod-giftcertificates-module">
	...
	<div class="order-wizard-paymentmethod-giftcertificates-module-expander-head">
		<a href="#" class="order-wizard-paymentmethod-giftcertificates-module-expander-head-toggle collapsed" data-toggle="collapse" data-target="#gift-certificate-form" aria-expanded="false" aria-controls="gift-certificate-form">
