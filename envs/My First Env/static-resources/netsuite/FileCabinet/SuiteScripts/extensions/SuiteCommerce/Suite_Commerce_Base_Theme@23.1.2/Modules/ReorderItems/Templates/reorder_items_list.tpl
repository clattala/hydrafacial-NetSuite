...
<div class="reorder-items-list">
	...
	{{#if itemsNotFound}}
		<div class="reorder-items-list-empty-section">
			<h5>{{translate 'You bought no items in this time period, ' 'After the comma there is a link that says: Shop Now'}}<a class="reorder-items-list-empty-button" href="#" data-touchpoint="home">{{translate 'Shop Now'}}</a></p>
		</div>
	{{/if}}
